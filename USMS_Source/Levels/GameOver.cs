...
namespace USMS_Source 
{
	public class GameOver : Sce.PlayStation.HighLevel.GameEngine2D.Scene
	{
		...
		public GameOver ()
		{
            ...
            ib.Image = new ImageAsset("/Application/Images/gameover.png",false);
            ib.Height = dialog.Height;
            ib.SetPosition(0.0f,0.0f);
            
            Button buttonUI1 = new Button();
            buttonUI1.Name = "buttonMainMenu";
            buttonUI1.Text = "Main Menu";
            buttonUI1.Width = 300;
            buttonUI1.Height = 50;
            buttonUI1.Alpha = 0.8f;
            buttonUI1.SetPosition(dialog.Width/2 - 150,170.0f);
